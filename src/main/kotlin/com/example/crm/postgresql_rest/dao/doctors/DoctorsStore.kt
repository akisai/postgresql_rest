...
data class DoctorsInfo(val name: String, val surname: String, val birthday: LocalDate, val procedure: String, val start: LocalTime, val end: LocalTime, val id: Long)
